...
bool signup()
{
    ...
    // string username,string password, string fullName, string phoneNumber, int creditPoints, House *ownHouse
    ...
    if (isValid)
    {
        ...
        Member member = Member(username, password, fullName, phoneNumber, 500, &House(location, description));
    }
}
