...
Member splitData(string data)
{
    ...
    members = new Member(userData[0], userData[1], userData[2], userData[3], stoi(userData[4]));
    // userData[5], std::stod(userData[6]),std::stod(userData[7]), userData[8], userData[9], std::stoi(userData[10]),std::stod(userData[11]) 
