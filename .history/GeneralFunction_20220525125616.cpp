...
bool signup()
{
    ...
    if (isValid)
    {
        string password = getData(password, "Password", false);
        string fullName = getData(fullName, "Full Name", false);
        string phoneNumber = getData(phoneNumber, "Phone Number", false);
        string location = getData(location, "Location", false);
        string description = getData(description, "Pasdescriptionsword", false);
